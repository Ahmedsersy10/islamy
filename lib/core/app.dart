...
import 'package:islamy/app/utils/app_prefs.dart';
import 'package:islamy/di/di.dart';
            ...
            providers: [
              ...
              BlocProvider(
                  create: (BuildContext context) => instance<QuranCubit>()
                    ...
                    ..getQuranSearchData()),
              BlocProvider(
                  create: (BuildContext context) => instance<HadithCubit>()..getHadithData()),
              BlocProvider(
                  create: (BuildContext context) => instance<PrayerTimingsCubit>()
                    ..getPrayerTimings()
                    ..isNetworkConnected()),
              BlocProvider(
                  create: (BuildContext context) => instance<AdhkarCubit>()..getAdhkarData()),
              BlocProvider(
