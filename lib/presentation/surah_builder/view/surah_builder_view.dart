...
class SurahBuilderView extends StatelessWidget {
  ...
  const SurahBuilderView({super.key, required this.quranList, required this.pageNo});
    ...
    return WillPopScope(
      ...
      child: BlocBuilder<QuranCubit, QuranState>(
        builder: (context, state) {
          ...
          final PageController pageController = PageController(initialPage: pageNo - 1);
                ...
                child: PageView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    ...
                    final List<QuranModel> pageSurahsList =
                        cubit.getPageSurahs(quran: quranList, pageNo: quranPageNumber);
                    ...
                    final List<AyahModel> ayahs =
                        cubit.getAyahsFromPageNo(quranList: quranList, pageNo: quranPageNumber);
                    return Column(
                      children: [
                        Row(
                        ...
                        //   child: Center(
                        //     child: Image.network(
                        //       "https://raw.githubusercontent.com/Ahmedsersy10/quran-images/main/page${getQuranImageNumberFromPageNumber(quranPageNumber)}.png",
                        //       fit: BoxFit.fitWidth,
                        ...
                        //         return Center(
                        //             child: Text(" فشل تحميل الصفحة يرجى الأتصال بالأنترنت"));
                        //       },
                        //     ),
                        //   ),
                        // ),
                        ...
                        FloatingActionButton(
                          ...
                          backgroundColor:
                              darkMode ? ColorManager.darkSecondary : ColorManager.lightPrimary,
                          child: Icon(
