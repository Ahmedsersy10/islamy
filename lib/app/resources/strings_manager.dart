class AppStrings {
  ...
  static const String giveLocationAccessPermission = "give_location_access_permission";
  ...
  static const String badRequest = "bad_request_error"; //failure, API rejected request
  static const String unauthorized = "unauthorized_error"; //failure, user is not authorized
  static const String forbidden = "forbidden_error"; //failure, API rejected request
  static const String notFound = "not_found_error";
  static const String internalServerError = "internal_server_error"; //failure, crash in server side
  ...
  static List<String> pillarsstring = [pillar1, pillar2, pillar3, pillar4, pillar5];
}
